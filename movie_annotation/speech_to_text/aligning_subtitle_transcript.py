...
for movie in movie_name:
    ...
    transcript_document = "/Users/huangjiawen/EBDb_project/movie_annotation/movie_subtitles_and_transcripts/%s_transcript.json"%movie
    ...
    workbook = xlsxwriter.Workbook('%s_word_timing.xlsx'%movie)
